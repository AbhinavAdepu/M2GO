 ...
 */
//fb256710747734013
#define SHKFacebookAppId			@"408604475846820"//@"256710747734013"
 ...
 */
#define SHKTwitterConsumerKey		@"XoGRuENYjJLzTgoB12QFQ"
#define SHKTwitterSecret			@"5VeBtVxe01RhFlfR5GmkhD309D2zHMn5KTa4FD2NyY"
#define SHKTwitterCallbackUrl		@"http://connect.mcgraw-hill.com/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"o_4kjegab5e7"
#define SHKBitLyKey					@"R_9739ca49286211880cd86e97d6d2bae4"
